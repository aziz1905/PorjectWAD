...
// 1. PERBAIKAN: Impor dari 'products.ts' dan gunakan 'allProducts' (huruf kecil)
...
const DetailProduk = () => {
    ...
    useEffect(() => {
        // Gunakan 'allProducts' yang sudah diimpor dengan benar
            ...
            <div className="detail-container">
                <div className="detail-main-grid">
                    <div className="detail-image-wrapper">
                        {/* 2. PERBAIKAN: Gunakan 'imageUrl' agar cocok dengan data */}
                 ...
                 <div className="mt-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                       {Products.filter(p => p.id !== id).slice(0, 4).map(p => (
                           <ProductCard key={p.id} id={p.id} name={p.name} description={p.description} price={p.price} imageUrl={p.imageUrl} sizes={p.sizes} category={p.category} />
                       ))}
                    </div>
                </div>
            </div>
